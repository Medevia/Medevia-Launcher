...
const { MojangRestAPI, getServerStatus }     = require('helios-core/mojang')     //Note this is for mojang status , not for login
            ...
            if(m.result == null){
                ...
                setDismissHandler(() => {
                    $('#overlayContent').fadeOut(250, () => {
                        ...
                        setOverlayContent(                                                      //TODO (translation)
